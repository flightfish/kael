...
class AliMailApi{
    ...
    const API_USER_LIST = "/ud/getAccountList";
...
//                "fingerPrint"=>$fingerPrint
            ...
            "param"=>empty($data) ? new \stdClass() : $data
        ];
...
//        }
    ...
    public static function allUserList($offset,$length,$fields=[
        'name',
        'email',
    ]){
        return self::curlApi(self::API_USER_LIST,[
            'offset'=>$offset,
            'length'=>$length,
            'fields'=>$fields
        ]);
