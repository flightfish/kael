...
class LdapController extends Controller
{
    ...
    public function actionUpdate(){
        ...
        try{
            ...
            //先查看删除的
            $listOld = CommonUser::getDb()->createCommand("select * from `user` a left join `user` b on a.mobile = b.mobile and a.id != b.id and b.`status` = 0 where a.ldap_update_time < a.update_time and a.status!=0 and b.id is null")->queryAll();
