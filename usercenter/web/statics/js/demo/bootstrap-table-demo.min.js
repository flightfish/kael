    ...
    buildTable(o("#exampleTableLargeColumns"), 50, 50), function () {
        ...
        function () {
            o("#exampleTableEvents").bootstrapTable({
                // url: "/qselect_user/user-common/user-table-list?token=TWWZ3cNKD5kIjImPUYCU/cM/XBZ5o7QjEG9OSdiHseRzx07 xzaJ9iZEtqghQceX",
                url: "/qselect_user/user-common/user-table-list?token=TWWZ3cNKD5kIjImPUYCU/cM/XBZ5o7QjEG9OSdiHseRzx07 xzaJ9iZEtqghQceX",
                dataType: "json",
                method:"post",
                search: !0,
            ...
            }).on("click-show-row.bs.table", function () {
                e.text("Event: click-show-row.bs.table")
            }).on("dbl-click-show-row.bs.table", function () {
                e.text("Event: dbl-click-show-row.bs.table")
