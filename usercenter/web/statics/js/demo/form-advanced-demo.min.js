$(document).ready(function () {
    ...
    var monthstart = myDate.getMonth()-5;       //获取当前月份(0-11,0代表1月)
    var monthend = myDate.getMonth()+1;
    var date = myDate.getDate();        //获取当前日(1-31)
    $('#datepicker input[name="start"]').attr('value',year+'-'+monthstart+'-'+date);
    $('#datepicker input[name="end"]').attr('value',year+'-'+monthend+'-'+date);
    $('#datepicker1 input[name="start"]').attr('value',year+'-'+monthstart+'-'+date);
    $('#datepicker1 input[name="end"]').attr('value',year+'-'+monthend+'-'+date);
