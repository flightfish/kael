...
layer.config({
    ...
    $(function() {
        ...
        if (localStorageSupport) {
            ...
            "on" == a && ($(".navbar-statics-top").removeClass("navbar-static-top").addClass("navbar-fixed-top"), l.addClass("fixed-nav")),
