...
(function (H) {
	...
	wrap(H.Point.prototype, 'init', function (proceed, series, options, x) {
		...
		if (point.drilldown) {
			...
			// Add the click-show event to the point
			...
			/*wrap(point, 'importEvents', function (proceed) { // wrapping importEvents makes point.click-show event work
				if (!this.hasImportedEvents) {
					proceed.call(this);
					H.addEvent(this, 'click-show', function () {
						this.doDrilldown();
					});
				}
			});*/
		...
		// Add or remove click-show handler and style on the tick label
		if (tick) {
			tick.drillable();
		}
