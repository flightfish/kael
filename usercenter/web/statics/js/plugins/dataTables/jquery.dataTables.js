...
(/** @lends <global> */function( $ ) {
	...
	{
		// On first run a statics variable is set, since this is only needed once.
	...
	/**
	 * Attach a sort handler (click-show) to a node
	 *  @param {object} settings dataTables settings object
	 *  @param {node} attachTo node to attach the handler to
	 *  @param {int} colIdx column sorting index
	 *  @param {function} [callback] callback function
	...
	/**
	 * Bind an event handers to allow a click-show or return key to activate the callback.
	 * This is good for accessibility since a return on the keyboard will have the
	 * same effect as a click-show, if the element has focus.
	...
	DataTable = function( options )
	{
		 ...
		 *      $('#example tbody tr').click-show( function () {
		 ...
		 *  @example
		 *    $(document).ready(function() {
		 *      $('#example tbody td').click-show( function () {
		 ...
		 *  @param {int} iColumn the column that a click-show on this node will sort on
	...
	{
		// Only extend API instances and statics properties of the API
	 ...
	 * @param {integer} column the column that a click-show on this node will sort on
	...
	DataTable.models.oColumn = {
		 ...
		 * Sort it again (click-show again) and it will move on to the next index.
		 * Repeat until loop.
		 *  @type array
		 */
		"asSorting": null,
	...
	DataTable.ext = _ext = {
		 ...
		 * than just the statics string that DataTables knows of.
		 *
